...
public class WebDriverEngine {
	...
	public void move_to_element(String string) {
		// TODO Auto-generated method stub
	...
	public void move_click(String linltext0) {
		Actions action=new Actions(driver);		
		action.moveToElement(driver.findElement(By.xpath(linltext0))).perform();
	}
	public void alert_click(String linltext0) throws InterruptedException {
		Actions action=new Actions(driver);		
		Thread.sleep(3000);
		action.click(driver.findElement(By.xpath(linltext0))).perform();
	}
